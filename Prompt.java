...
public class Prompt
{
	...
	public static char getChar (String ask)
	{
		...
		while(! found && str.length()>1){
			...
			//java.lang is loaded automtically every timeyou compile. needs a base api to compile every time
			//string, integer, etc. are all loaded into java.lang automagically :)
